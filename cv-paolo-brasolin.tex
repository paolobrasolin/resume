...
\AddToShipoutPictureFG{%
  \begin{tikzpicture}[remember picture,overlay]
    \node [
      ...
      ] at (2\Pad,\pdfpageheight-\Pad-0.5\Row)
      {
        \strut paolobrasolin@gmail.com
        ...
        \par\smallskip
        %
        \strut (+39)\ 347\ 6769233
        \hfill\Fa{Phone}
        % \par\smallskip
        % \strut Padua, IT, Italy
        % \hfill\Fa{Home}\\
      };
  \end{tikzpicture}}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    \node [
      ...
      {%
        ...
        \href{https://github.com/paolobrasolin/fletcher}%
        {\llap{\textsuperscript{\tiny\color{InverseMuted}\Fa{Link}}}{\ttfamily fletcher}}:
        universal DSL transpiler for commutative diagrams drawn with \hologo{TeX}
...
I'm also overseeing the modernization of the institute's k8s cluster.
...
\Event
  ...
  {\llap{\textsuperscript{\mdseries\tiny\color{Muted}\Fa{Link}}}%

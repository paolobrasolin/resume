...
\AddToShipoutPictureFG{%
  \begin{tikzpicture}[
    remember picture,
    overlay,
    shift={(\pdfpagewidth-\Pad,\Pad)},
    red,
    line width=0.6pt,
    y=\dimexpr\pdfpageheight/200\relax,
    x=2.4pt,
    violet,
  ]
    \draw (0, {(2010-2010)*12 + ( 1-1)}) -- (0, {(2020-2010)*12 + ( 1-1)}) -- (TT); % STEM
    \draw (1, {(2015-2010)*12 + ( 1-1)}) -- (1, {(2021-2010)*12 + ( 7-1)}) -- (DD); % TEX
    \draw (2, {(2016-2010)*12 + ( 6-1)}) -- (2, {(2017-2010)*12 + ( 1-1)}) -- (IS); % idea
    \draw (2, {(2017-2010)*12 + ( 3-1)}) -- (2, {(2018-2010)*12 + (12-1)}) -- (LBDEV); % lb dev
    \draw (2, {(2019-2010)*12 + ( 1-1)}) -- (2, {(2021-2010)*12 + ( 7-1)}) -- (LBLEAD); % lb lead
    \draw (3, {(2017-2010)*12 + ( 7-1)}) -- (3, {(2021-2010)*12 + ( 7-1)}) -- (RB); % ribo
    \draw (4, {(2019-2010)*12 + ( 1-1)}) -- (4, {(2020-2010)*12 + ( 4-1)}) -- (MN); % mann
  \end{tikzpicture}}
...
\Event
  ...
  {Jan 2019 -- \textbf{now}}%
\tikz[remember picture]\coordinate(LBLEAD);
...
\Event
  ...
  {Jan 2019 -- Apr 2020}%
  \tikz[remember picture]\coordinate (MN);
...
\Event
  ...
  {Jul 2017 -- \textbf{now}}%
  \tikz[remember picture]\coordinate (RB);
...
\Event
  ...
  {Leanbit S.r.l.}[Padua, IT]
  {Mar 2017 -- Dec 2018}%
  \tikz[remember picture]\coordinate (LBDEV);
...
\Event
  ...
  {Ideasmart}[Padua, IT]
  {Jun 2016 -- Jan 2017}%
  \tikz[remember picture]\coordinate (IS);
...
\Event
  ...
  {freelance}
  {2015 -- \textbf{now}}%
  \tikz[remember picture]\coordinate (DD);
...
\Event
  ...
  {freelance}
  {2010 -- 2020}%
  \tikz[remember picture]\coordinate (TT);

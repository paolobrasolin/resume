...
\AddToShipoutPictureFG{%
  \begin{tikzpicture}[remember picture,overlay]
    \node [ 
      ...
      rotate=180,
      minimum size=0.618\Col,
      inner sep=0,
    ] at (\Pad+0.5\Col,0.5\Col)
    {\includegraphics[angle=180,width=0.236\Col]{glyph.mps}};
  \end{tikzpicture}}
...
\hologo{TeX} pipeline which eliminated many difficulties for future authors.
...
implement two staple \hologo{TeX} tools of their ecosystem. Furthermore,
